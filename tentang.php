        ...
        <div id="layoutSidenav_content">
            <main>
                <section class="ftco-section">
                    ...
                    <div class="section-title text-center m-4">
                        <h2 data-aos="fade-up" data-aos-duration="500" style="color: #800000;"
                            class="display-7 fw-bold lh-1 mt-3 mb-3">Author
                        </h2>
                    </div>
                </section>

                <div data-aos="fade-zoom-in" data-aos-duration="1000" class="mb-3">
                    <div class="card-body">
                        <div class="d-flex flex-column align-items-center text-center">
                            <img src="avatar.png" alt="User" class="rounded-circle text-center" width="200">
                        </div>
                    </div>
                </div>
                <div data-aos="fade-up" data-aos-duration="500" style="color:#800000"
                    class="text pl-3 ms-2 text-center">
                    <h4><span>Roni Merdiansah</span></h4>
                    <h4><span>2010631250097</span></h4>
                </div>
            </main>
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid px-4">
                    <div class="d-flex align-items-center justify-content-center small">
                        <div class="text-muted">Copyright &copy; Roni Merdiansah</div>
                    </div>
                </div>
            </footer>
        </div>
